...
import com.example.adminappkisan.adapter.DeliveryAdapter
import com.example.adminappkisan.databinding.ActivityOutForDeliveryBinding
...
//retrieve display completed order
...
//clear the list before populating it with new data
    ...
    private fun setDataIntoRecyclerView() {
        //Initializing List to hold customer name and payment status
